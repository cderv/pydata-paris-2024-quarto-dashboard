...
![](images/PyData_logo.png){.absolute bottom='35px' right='100px' width='50%'}
...
![](images/horst_quarto_schematic.png){fig-alt="A schematic representing the multi-language input (e.g. Python, R, Observable, Julia) and multi-format output (e.g. PDF, html, Word documents, and more) versatility of Quarto." fig-align="center" height="30%"}
...
[Calling in terminal:]{.smaller}

::: {.top-pad}
::: {.columns}
::: {.column}
``` {.bash}
quarto render my-doc.ipynb
quarto render my-doc.ipynb --execute
```
:::
::: {.column} 
``` {.bash}
# will execute and render
...
::: r-stack
![](images/screenshot-vscode-preview.png){.fragment .fade-in-then-out fragment-index="1" }

![](images/vscode-logo.png){.fragment .absolute fragment-index="1" top="0px" right="450px" width="100px"}

![](images/jupyterlab-preview.png){.fragment .fade-in-then-out fragment-index="2" }

![](images/jupyter-logo.png){.fragment .absolute fragment-index="2" top="0px" right="300px" width="100px"}

![](images/screenshot-positron.png){.fragment .fade-in-then-out fragment-index="3" }
...
## {.no-line background-image="images\dashboards\olympics\screenshot.png" background-size="contain"}

::: {.footer}
<https://mine.quarto.pub/olympic-games-py/#summer-olympics>
:::
...
![](images\dashboards\olympics\navbar.png)

::: {style="margin-top: 0.7em;"}
``` {.python code-line-numbers="|2|5-6|7-8|11,13"}
---
title: "Olympic Games"
format: 
  dashboard:
...
##  {.no-line background-image="images\dashboards\olympics\nav-pages.gif" background-size="contain" footer=false}
...
```` {.python code-line-numbers="|5|8,13|8-19"}
---
title: "By Columns"
format: 
  dashboard:
...
````{.markdown code-line-numbers="1-3|5-10|12-18|20-26"}
...
`` `{python} str(count_most_gold_medals)` `` is an inline code syntax that is supported in Quarto to easily mix Markdown Text and computation output value.
...
##  {.no-line background-image="images\dashboards\olympics\tabsets.gif" background-size="contain" footer=false}
...
![](images/thank-you.gif){.absolute bottom="-50px" right="500px" height="200px"}
:::